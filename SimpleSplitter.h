...
{
public:
	CSimpleSplitter(int nPanes, UINT nOrientation = SSP_HORZ, int nMinSize = 30, int nBarThickness = 1);
	~CSimpleSplitter();
...
//	BOOL CreatePane(int nIndex, HLSLEdit * pPaneWnd);
	BOOL CreatePane(int nIndex, CRichEditCtrl * pPaneWnd);
